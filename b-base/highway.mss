...
#bikeways {
  ::CASING {
    ...
    /* off street */
    [FAC_TYPE="Separated Bikeways"] { line-color: darken(@bike_separated, 10%); }

    /* neighbourhood bikeway */
    [FAC_TYPE="Local Street Bikeways"] { line-color: darken(@bike_local, 10%); }

    /* bike lane */
    [FAC_TYPE="Painted Bike Lanes"] { line-color: darken(@bike_lane, 10%); }

    /* shared roadway */
    [FAC_TYPE="Painted Shared-Use Lanes"] { line-color: darken(@bike_shared, 10%); } 

    [zoom=13]{ line-width:3 + 2; }
    [zoom=14]{ line-width:4 + 2; } 
    [zoom=15]{ line-width:7 + 2; }
  ...
  /* off street */
  [FAC_TYPE="Separated Bikeways"] { line-color: @bike_separated; }

  /* neighbourhood bikeway */
  [FAC_TYPE="Local Street Bikeways"] { line-color: @bike_local; }

  /* bike lane */
  [FAC_TYPE="Painted Bike Lanes"] { line-color: @bike_lane; }

  /* shared roadway */
  [FAC_TYPE="Painted Shared-Use Lanes"] { line-color: @bike_shared; } 
